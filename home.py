...
st.set_page_config(
    page_title="Deepak Kumar Portfolio",
    page_icon="📊",
)
...
def home_page():
    ...
    with st.sidebar:
        ...
        st.write("**Author:** Deepak Kumar")
        st.write("**Instructor:** [Enric Domingo](https://github.com/enricd)")


    # ----- Top title -----
    st.html("""<div style="text-align: center;"><h1 style="text-align: center;">👋 Hi! My name is Deepak Kumar????</h1></div>""")  # TODO: Add your name
    ...
    current_role = "Masters in Big Data Analytics at EAE Business School"   # TODO: Change this
